...
public class Touchi : MonoBehaviour
{
    // シングルトン
    private static Touchi _instance;
    private static Touchi Instance
    {
        get
        {
            if (_instance == null)
            {
                var obj = new GameObject(typeof(Touchi).Name);
                _instance = obj.AddComponent<Touchi>();
            }
            return _instance;
        }
    }
